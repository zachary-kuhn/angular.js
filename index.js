/**
 * @license AngularJS v1.3.0-local+sha.8ac9035
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.3.0-local+sha.8ac9035/' +
      (module ? module + '/' : '') + code;
...
var /** holds major version number for IE or NaN for real browsers */
    ...
    // whenever the entering from the test suite, exports is undefined
 ...
 */
var version = {
  full: '1.3.0-local+sha.8ac9035',    // all of these placeholder strings will be replaced by grunt's
...
!this.angular.$$csp() && this.angular.element(document).find('head').prepend('<style type="text/css">@charset "UTF-8";[ng\\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide:not(.ng-animate){display:none !important;}ng\\:form{display:block;}</style>');